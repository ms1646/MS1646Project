...
try:
   #boto3
   sqs = boto3.resource('sqs',aws_access_key_id =  'AKIAWNKTUM4AQA7BEMV6',
                        aws_secret_access_key = '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')
   queue = sqs.create_queue(QueueName='ms1646', Attributes={'DelaySeconds': '5'})
